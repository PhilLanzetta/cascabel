    ...
    <>
      ...
      <main>
        ...
        <nav className="desktop-nav">
          <AnchorLink offset="24" href="#Art">
            Art
          </AnchorLink>
          <AnchorLink offset="24" href="#Events">
            Events
          </AnchorLink>
          <AnchorLink offset="24" href="#Music">
            Music
          </AnchorLink>
          <AnchorLink offset="24" href="#Wellness">
            Wellness
          </AnchorLink>
          <AnchorLink offset="24" href="#Community">
            Community
          </AnchorLink>
        </nav>
        <TextImage
